...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCoordinatorLayout = (CoordinatorLayout)
                mRootView.findViewById(R.id.root_coordinator_layout);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if(getActivity().getIntent() != null) {
                ...
                photoView.setTransitionName(getString(R.string.transition_tag) + String.valueOf(mItemId));
            }
        ...
        //mDetailToolbar.setNavigationIcon(R.drawable.abc_ic_ab_back_mtrl_am_alpha );
